/**
 * Firebase Configuration for Hospital Admin Portal
 *
 * SETUP INSTRUCTIONS:
 * 1. Go to https://console.firebase.google.com → Project: swiva-257eb
 * 2. Click the gear icon → Project Settings → Your apps
 * 3. Click "Add app" → Web (</>)  (name it "Hospital Portal")
 * 4. Copy the firebaseConfig object and replace the values below
 * 5. Make sure Firestore rules allow hospital role reads
 */
...
const firebaseConfig = {
  ...
  appId:             '1:137301333148:web:f1f823f86f6eb2232b4959',   // ← Replace from Firebase Console
};
